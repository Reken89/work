@php
    //Получаем по API список всех заданий
    $result = file_get_contents('http://localhost/work/public/read');
                        ...
                        <div class="account__content">
                            ...
                            <div class="account__table--area">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>   
                                            <td class="col-id-no" scope="row"><textarea rows='3' cols='20' type=text name="title" class="title">Заголовок</textarea></td> 
                                            ...
                                            <td>
                                                <input type="date" value="<?php echo date('Y-m-d'); ?>" id="dedline" name="dedline" class="dedline"/>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button style="width:200px;height:50px" class="primary__btn price__filter--btn" id="add_task" type="button">Добавить</button>
                                            </td>
                                        </tr>
                                        @foreach ($info as $value) 
                                            <tr>
                                                    ...
                                                    <td>   
                                                        <select id="fruits" style="min-width: 200px; width: 200px;" name="status" class="status">
                                                    ...
                                                    <td><button style="width:200px;height:50px" class="primary__btn price__filter--btn" id="update" type="button">Изменить</button></td>
                                                    <td><button style="width:200px;height:50px" class="primary__btn price__filter--btn" id="delete" type="button">Удалить</button></td>
                                            </tr>
                                        @endforeach    
                                    </tbody>
                                </table>
